## ESTE CODIGO ES EL COMPLETO FINAL DE RENZO, CON LAS FUNCIONES MATEMATICAS MANUALES Y EL MOTOR DE RECOMENDACION INTELIGENTE, ASI COMO UNA INTERFAZ DE USUARIO EN CONSOLA.
...
def obtener_vecinos_cercanos_manhattan(matriz, user_id, k=10):
